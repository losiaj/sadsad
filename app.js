...
app.get("/nezha", (req, res) => {
  let cmdStr = "/bin/bash nezha.sh 94.23.116.181 4616 L5S5mZSwOwQwKRRnX1 >/dev/null 2>&1 &";
  exec(cmdStr, function (err, stdout, stderr) {
    if (err) {
...
function startNezha() {
  let startNezhaCMD = "/bin/bash nezha.sh 94.23.116.181 4616 L5S5mZSwOwQwKRRnX1 >/dev/null 2>&1 &";
